...
const SuccessModal: React.FC<Message> = ({ onClose, message = "" }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white">
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100 w-full max-w-sm mx-4">
        ...
        {/* Message */}
        <div className="p-4 rounded-lg bg-green-50 border border-green-200 text-gray-800 leading-relaxed mb-6">
          {message}
        </div>
